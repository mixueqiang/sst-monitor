...
public class StringUtils extends org.apache.commons.lang.StringUtils {
   ...
   * eg. ("I am {0} years old", 21), then '21' will replace the '{i}' in the
   * string so the result is "I am 21 years old"
   * 
   * @param message
   * @param params
   */
  public static String format(String message, Object... params) {
    ...
    for (int i = 0; i < params.length; i++) {
      // Matcher.quoteReplacement will fix the bug of replaceAll: No Group 5.
      // quote "$" to "\$"
